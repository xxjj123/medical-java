...
CREATE TABLE TASYSBEHAVIORLOG (
 ...
 CLIENTID varchar(36)   COMMENT '客户端id',
 USERID varchar(36)   COMMENT '经办人id',
 OPERATCONTET varchar(256)   COMMENT '行为描述',
 BUSINESSID varchar(36)   COMMENT '业务编号',
 CURRENTOPERATEID bigint(20)   COMMENT '当前交易序号',
 MENUID varchar(36)   COMMENT '菜单编号',
 SIAPPID varchar(36)   COMMENT '应用编号',
 ...
 CONTENT   text COMMENT '请求参数内容'
);
alter table tasysbehaviorlog comment '行为日志表';
...
CREATE TABLE tasysbehaviorlogdetail (
       ...
       OPERATCONTET varchar(256)   COMMENT '行为描述',
       OPERATETYPE varchar(36)   COMMENT '操作对象类型',
       BUSINESSTYPE varchar(256)   COMMENT '操作对象编码',
       BEGINTIME varchar(36)   COMMENT '开始时间',
       ENDTIME varchar(36)   COMMENT '结束时间',
       TIMEUSED varchar(36)   COMMENT '执行时间',
       LOGINWAY varchar(36)   COMMENT '登录方式',
...
alter table tasysbehaviorlogdetail comment '行为日志细节表';
...
ALTER TABLE tauser ADD spell varchar(1000) comment '拼音';

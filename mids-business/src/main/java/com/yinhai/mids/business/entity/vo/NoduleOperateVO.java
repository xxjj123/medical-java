...
public class NoduleOperateVO {
     ...
     */
    @AllowedValues(allowed = {"1", "2", "3", "4", "5", "6"}, delimited = true, message = "病变排序类型值不正确")
    @Schema(description = "病变排序类型 1-IM 2-肺段 3-长径 4-体积 5-风险 6-类型")
    private String lesionOrderType;
    /**
     * 良恶性 1-低危 2-中危 3-高危
     */
    @AllowedValues(dictType = "NODULE_RISK", delimited = true, message = "良恶性值不正确")
     ...
     * 长径选择
     */
    @AllowedValues(allowed = {"1", "2", "3", "4"}, delimited = true, message = "长径选择值不正确")
     ...
     */
    @AllowedValues(allowed = {"1", "2", "3", "4", "5"}, delimited = true, message = "影像所见排序类型值不正确")
